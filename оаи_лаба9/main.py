...
def build_readme_pdf(
    ...
    y = text_block(
        draw1,
        f"Для выполнения задания была выполнена запись звучания гитары {source_meta['source_name']}. Файл декодирован в монофонический WAV с частотой {metrics[0][1]} Гц. Для анализа спектра и подавления шума применено оконное преобразование Фурье с окном Ханна.",
        92,
        y,
        1468,
        body_font,
